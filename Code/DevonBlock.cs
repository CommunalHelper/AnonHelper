...
namespace Celeste.Mod.Anonhelper {
    ...
    public class DevonBlock : Solid {
        ...
        private readonly bool chillOut;
        private readonly bool giant;
        private readonly bool counterClockwise = false;
        ...
        private void AddImage(MTexture idle, int x, int y, int tx, int ty, int borderX = 0, int borderY = 0) {
            ...
            if (borderX != 0 || borderY != 0) {
                if (borderX < 0) {
                    Image image4 = new(GFX.Game["objects/crushblock/lit_left"].GetSubtexture(0, ty * 8, 8, 8));
                    activeLeftImages.Add(image4);
                    image4.Position = vector;
                    image4.Visible = false;
                    Add(image4);
                } else if (borderX > 0) {
                    Image image5 = new(GFX.Game["objects/crushblock/lit_right"].GetSubtexture(0, ty * 8, 8, 8));
                ...
                if (borderY < 0) {
                    Image image6 = new(GFX.Game["objects/crushblock/lit_top"].GetSubtexture(tx * 8, 0, 8, 8));
                    activeTopImages.Add(image6);
                    image6.Position = vector;
                    image6.Visible = false;
                    Add(image6);
                } else if (borderY > 0) {
                    Image image7 = new(GFX.Game["objects/crushblock/lit_bottom"].GetSubtexture(tx * 8, 0, 8, 8));
        ...
        private IEnumerator AttackSequence() {
            ...
            if (crushDir == -Vector2.UnitX) {
                ...
                Vector2 value2 = new(0f, 2f);
                for (int j = 0; j < Height / 8f; j++) {
                    Vector2 vector2 = new(Right + 1f, Top + 4f + (j * 8));
                ...
                Vector2 value3 = new(2f, 0f);
                for (int k = 0; k < Width / 8f; k++) {
                    Vector2 vector3 = new(Left + 4f + (k * 8), Top - 1f);
                ...
                Vector2 value4 = new(2f, 0f);
                for (int l = 0; l < Width / 8f; l++) {
                    Vector2 vector4 = new(Left + 4f + (l * 8), Bottom + 1f);
