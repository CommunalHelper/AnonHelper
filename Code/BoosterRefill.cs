...
namespace Celeste.Mod.Anonhelper {
    [CustomEntity("Anonhelper/BoosterRefill")]
    public class BoosterRefill : Entity {
        public static ParticleType P_Shatter = new() {
            Source = GFX.Game["particles/bubble"],
            Color = Calc.HexToColor("9c1105"),
            Color2 = Calc.HexToColor("d42c40"),
        ...
        public BoosterRefill(Vector2 position, bool oneUse, bool boostOnEnd)
            : base(position) {
            ...
            string spriteID = boostOnEnd ? "boosterRefillOnDash" : "boosterRefill";
        ...
        public BoosterRefill(EntityData data, Vector2 offset)
            : this(data.Position + offset, data.Bool("oneUse"), data.Bool("boostOnEnd")) {
        }
        ...
        private void OnPlayer(Player player) {
            if (!AnonModule.Session.HasBoosterDash) {
                ...
                AnonModule.Session.HasBoosterDash = true;
